...
# Naproxen inside gamma-CD
# Colour = normalised BANLayer attention (blue=low, red=high)

load /home/nibiohnproj9/cycheng/cd_gnn_training/CD_BAN/results/pymol/gamma_CD.pdb, cd_host
...
alter (cd_host and index 50), b=0.924353
alter (cd_host and index 51), b=0.864818
alter (cd_host and index 52), b=0.965443
alter (cd_host and index 53), b=0.997220
alter (cd_host and index 54), b=0.999600
alter (cd_host and index 55), b=1.000000
alter (cd_host and index 56), b=0.960602
alter (cd_host and index 57), b=0.891719
alter (cd_host and index 58), b=0.995201
alter (cd_host and index 59), b=0.900827
alter (cd_host and index 60), b=0.987696
alter (cd_host and index 61), b=0.900827
alter (cd_host and index 62), b=0.987696
alter (cd_host and index 63), b=0.891719
alter (cd_host and index 64), b=0.995201
alter (cd_host and index 65), b=0.900827
alter (cd_host and index 66), b=0.987696
alter (cd_host and index 67), b=0.891719
alter (cd_host and index 68), b=0.995201
alter (cd_host and index 69), b=0.900827
alter (cd_host and index 70), b=0.987696
alter (cd_host and index 71), b=0.891719
alter (cd_host and index 72), b=0.995201
alter (cd_host and index 73), b=0.900827
alter (cd_host and index 74), b=0.987696
alter (cd_host and index 75), b=0.891719
alter (cd_host and index 76), b=0.995201
alter (cd_host and index 77), b=0.900827
alter (cd_host and index 78), b=0.987696
alter (cd_host and index 79), b=0.891719
alter (cd_host and index 80), b=0.995201
alter (cd_host and index 81), b=0.900827
alter (cd_host and index 82), b=0.987696
alter (cd_host and index 83), b=0.891719
alter (cd_host and index 84), b=0.995201
alter (cd_host and index 85), b=0.900827
alter (cd_host and index 86), b=0.987696
alter (cd_host and index 87), b=0.891719
alter (cd_host and index 88), b=0.995201
...
# png results/pymol/gamma_CD_naproxen.png, width=1200, height=900, dpi=300